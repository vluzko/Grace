...
(import "gradual_binary_ops" "call_gradual" (func $.gradual_binary_ops.call_gradual (param $i i32) (param $a i32) (param $b i32)
(import "memory_management" "mem" (memory (;0;) 1)) (result i32)))

(func $gradual_add (param $x i32) (param $x i32) (result i32) (local $x i32)
i32.const 0
get_local $x
get_local $y
